...
<img class=header_img_logo src="images/headlogo.png" alt="従業員 ログイン画面へ" >
</a>
...
<a href="/azps_kintai/Logout">
<!--画像の読み込み-->
<img class="header_img_logo" src="images/headlogo.png" alt="従業員 メイン画面へ" >
</a>
<%} %><!-- if文終わり -->
 --%>
<nav>
...
<li><a href="/azps_kintai/Logout">ログアウト　</a></li>
